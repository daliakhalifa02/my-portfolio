...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_h1enb46','template_hnhuv0u','#contact-form','xnx8Hj4L5gHm1InVl')
    .then(() => {
        // Show sent message
        ...
        // Show error message
        contactMessage.textContent = `Error! Message couldn't be sent!`
    })
}
...
sr.reveal(`.projects__cards`, {interval: 100})